...
public class Remarque implements Comparable<Remarque> {
	...
	/**
	 * CONSTRUCTEUR DE RECOPIE DE LA CLASSE PARC. UTILISEE POUR SAUVEGARDER UNE
	 ...
	 * 
	 * @param newDate
	 *            Nouvelle date de la remarque de type 'LocalDate'.
	 * @return Aucun.
	 */
	 ...
	 * 
	 * @param newTexte
	 *            Nouveau texte de la remarque de type 'String'.
	 * @return Aucun.
	 */

...
public class Parc {
	...
	/**
	    ...
	    @param pParc	Nom du parc d'engins moteurs à creer, de type 'String'.
	    @return			Aucun.
	*/
	...
	*/
	...
	/**
	    ...
	    @param 					Aucun.
	    @return	nbEnginsVus		Nombre d'engins moteurs ayant au moins une vue enregistrée, de type 'int'.
	*/
	...
	*/
	...
	/**
	    ...
	    @param 						Aucun.
	    @return	nbEnginsPreserves	Nombre d'engins moteurs préservés, de type 'int'.
	*/
	...
	*/
	...
	/**
	    ...
	    @param 				Aucun.
	    @return	boxSeries	Liste des séries du parc de type 'String[]'.
	    					Utilisée pour créer la 'JComboBox' des séries dans la classe 'RechercheSerie'.
	*/
	...
	/**
	    ...
	    @param pIdentifiant :	Identifiant de la nouvelle série de type 'Identifiant'.
	    @param pSerie :			Numéro de la nouvelle série de type 'int'.
	    @param effectif :		Nombre d'engins moteurs de la nouvelle série de type 'int'.
	    @return					Aucun.
	*/
	...
	/**
	    ...
	    @param serieCherchee :	Nom complet (identifiant + numéro) de la série cherchée, de type 'String'.
	    @return	resultat :		Série trouvée de type 'Serie'. Le résultat est unique et certain par construction.
	*/
	...
	/**
	    ...
	    @param id :				Identifiant de l'engin moteur cherché, de type 'Identifiant'.
	    @param numCherche		Numéro de l'engin moteur cherche, de type 'int'.
	    @return	enginTrouve :	Engin moteur trouvé de type 'Engin' si la recherche a abouti. Le résultat est dans ce cas unique.
	    						'null' sinon.
	*/
	...
	*/
	...
	/**
	    ...
	    @param				Aucun.
	    @return derniere	Date de la dernière vue enregistrée, de type 'LocalDate'.
	*/

...
public class Voyage {
	...
	*/
	...
	/**
		CONSTRUCTEUR DE RECOPIE DE LA CLASSE VOYAGE.
		UTILISEE POUR SAUVEGARDER UNE VUE AVANT MODIFICATION DANS LA CLASSE 'FenetreVue'.
	    @param v	Voyage à recopier, de type 'Voyage'.
	    @return		Aucun.
	*/
	...
	*/
	...
	/**
	    ...
	    @param newDepart	Nouvelle gare d'arrivée de type 'String'. L'association au type 'Gare' est faite automatiquement.
	    @return				Aucun.
	*/
	...
	/**
		MODIFIE LA GARE D'ARRIVEE DU VOYAGE.
	    @param newDepart	Nouvelle gare d'arrivée de type 'Gare'.
	    @return				Aucun.
	*/
	...
	*/
	...
	/**
	    ...
	    @param v			Voyage à comparer avec 'this', de type 'Voyage'.

...
public class Engin {
	...
	*/
	...
	/**
	    ...
	    @param newSerie 	Nouvelle série de type 'Serie'.
	    @return				Aucun.
	*/
	...
	/**
	    ...
	    @param newIdentifiant	Nouvel identifiant de l'engin de type 'Identifiant' (identique à celui de sa série).
	    @return					Aucun.
	*/
	...
	/**
	    ...
	    @param				Aucun.
	    @return nomComplet	Nom complet de la série de l'engin de type 'String' (identifiant et numéro) si la série a été définie.
	    					Chaine de caractère vide sinon.
	*/
	...
	*/
	...
	/**
	    ...
	    @param newNumero	Nouveau numéro de l'engin de type 'int'.
	    @return				Aucun.
	*/
	...
	/**
	    ...
	    @param	Aucun.
	    @return	Nom complet de l'engin de type 'String' constitué de l'identifiant et du numéro.
	*/
	...
	/**
	    ...
	    @param					Aucun.
	    @return	renumerotation	Nouveau numéro de l'engin de type 'int' s'il a été renuméroté ou transformé.
	    						0 sinon.
	*/
	...
	/**
	    ...
	    @param newRenumerotation	Nouveau numéro de l'engin de type 'int'.
	    @return						Aucun.
	*/
	...
	*/
	...
	/**
	    ...
	    @param newEtat	Nouvel état de l'engin de type 'String'. L'association au type 'Etat' est faite automatiquement.
	    @return			Aucun.
	*/
	...
	/**
	    ...
	    @param				Aucun.
	    @return	dateMES		Date de mise en service de l'engin de type 'LocalDate' si l'engin a été mis en service.
	    					LocalDate.now() sinon.
	*/
	...
	/**
	    ...
	    @param newDateMES	Nouvelle date de mise en service de l'engin de type 'LocalDate'.
	    @return				Aucun.
	*/
	...
	/**
	    ...
	    @param				Aucun.
	    @return	dateMES		Date de radiation de l'engin de type 'LocalDate' si l'engin a été radié.
	    					LocalDate.now() sinon.
	*/
	...
	/**
	    ...
	    @param newDateMES	Nouvelle date de radiation de l'engin de type 'LocalDate'.
	    @return				Aucun.
	*/
	...
	/**
	    ...
	    @param
	    @return	associationPR	Association de préservation de l'engin de type 'Association' si l'engin a été préservé.
	    						Association.vide sinon.
	*/
	...
	/**
	    ...
	    @param formatLong	Booléen indiquant le format de la chaine de caractère retournée.
	    						true = nom de l'association et lieu (utilisé dans la classe graphique 'Infos').
	    						false = uniquement le nom de l'association.
	...
	*/
	...
	/**
	    ...
	    @param newAssociation	Nouvelle association de préservation de l'engin de type 'String'.
	    						Le lien avec le type 'Association' et l'affectation du lieu sont réalisés automatiquement.
	    @return					Aucun.
	*/
	...
	*/
	public void calculerAge() {
		if (etat == Etat.R) {
			// Engin radié -> age = période entre sa mise en service et sa radiation.
			age = Period.between(dateMES, dateRAD) ;
		}
		else {
			if (etat == Etat.AMES) {
				...
				// Engin en service ou préservé -> age = période entre sa mise en service et aujourd'hui.
	...
	/**
	    ...
	    @param formatLong	Booléen indiquant le format d'affichage de l'âge.
	    						true = le nombre d'années, de mois et de jours sont indiqués.
	    						false = l'âge est converti en un nombre décimal.
	    @return	Aucun.
	*/
	...
	*/
	...
	/**
	    ...
	    @param date		Date de type 'LocalDate' à comparer avec la date de mise en service de l'engin.
	...
	*/
	...
	/**
	    ...
	    @param newLivree	Nouvelle livrée de l'engin de type 'String'. L'association au type 'Livree' est faite automatiquement.
	    @return				Aucun.
	*/
	...
	*/
	...
	/**
	    ...
	    @param newLivree	Nouveau dépôt de l'engin de type 'String'. L'association au type 'Depot' est faite automatiquement.
	    @return				Aucun.
	*/
	...
	/**
	    ...
	    @param dossierPhoto		Chemin absolu de type 'String' du dossier où chercher la photo.
	    @return					Aucun.
	*/
	public void chercherPhoto(String dossierPhoto) {
		...
		for (i=0 ; i<(fichiers.length) ; i++) {
			...
			if ((f.isFile()) && (nomF.compareTo(Integer.toString(numero)) == 0)) {
				photo = true ;
	...
	/**
	    ...
	    @return photo	Booléen indiquant si l'engin possède une photo enregistrée.
	    				true = l'engin possède une photo.
	    				false = l'engin ne possède pas de photo.
	*/
	...
	/**
	    ...
	    @param					Aucun.
	    @return cheminPhoto		Chemin absolu de type 'String' pointant sur la photo de l'engin si elle existe.
	    						Chemin absolu de la photo 'Vide.jpg' sinon. 
	*/
	...
	*/
	...
	/**
	    ...
	    @param newVue	Nouvelle vue à ajouter de type 'Vue'.
	    @return 		Aucun.
	*/
	...
	/**
		RETOURNE LA DATE DE LA VUE LA PLUS RECENTE DE L'ENGIN.
	...
	*/
	...
	/**
	    ...
	    @param				Aucun.
	    @return listeVues	Liste des remarques sur l'engin de type Vector<Remarque>.
	*/
	...
	/**
	    ...
	    @param newRemarque	Nouvelle remarque à ajouter de type 'Remarque'.
	    @return 			Aucun.
	*/

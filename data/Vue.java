...
public class Vue implements Comparable<Vue> {
	...
	*/
	...
	/**
		CONSTRUCTEUR DE RECOPIE DE LA CLASSE VUE.
		UTILISEE POUR SAUVEGARDER UNE VUE AVANT MODIFICATION DANS LA CLASSE 'FenetreVue'.
	    @param v	Vue à recopier, de type 'Vue'.
	    @return		Aucun.
	*/
	public Vue(Vue v) {
		date = v.getDate() ;
	...
	/**
	    ...
	    @param newDate	Nouvelle date de la vue de type 'LocalDate'.
	    @return			Aucun.
	*/
	...
	*/
	...
	/**
	    ...
	    @param newLieu	Nouveau lieu de la vue de type 'String'. L'association au type 'Lieu' est faite automatiquement.
	    @return			Aucun.
	*/
	...
	/**
		MODIFIE LE LIEU DE LA VUE.
	    @param newLieu	Nouveau lieu de la vue de type 'Lieu'.
	    @return			Aucun.
	*/
	...
	*/
	...
	/**
	    ...
	    @param newDepart	Nouvelle gare de départ de type 'String'. L'association au type 'Gare' est faite automatiquement.
	    @param newArrivee	Nouvelle gare d'arrivée de type 'String'. L'association au type 'Gare' est faite automatiquement.
	    @return				Aucun.
	*/
	...
	/**
		MODIFIE LE VOYAGE DE LA VUE.
	    @param newDepart	Nouvelle gare de départ de type 'Gare'.
	    @param newArrivee	Nouvelle gare d'arrivée de type 'Gare'.
	    @return				Aucun.
	*/
	...
	*/
	...
	/**
	    ...
	    @param newTrain		Nouveau train de la vue de type 'String'. L'association au type 'Train' est faite automatiquement.
	    @return				Aucun.
	*/
	...
	/**
		MODIFIE LE TYPE DE TRAIN DE LA VUE.
	    @param newTrain		Nouveau train de la vue de type 'Train'.
	    @return				Aucun.
	*/
	...
	*/
	...
	/**
	    ...
	    @param newCabine	Nouvelle indication de cabine de type 'boolean'.
	    @return				Aucun.
	*/
	...
	/**
	    ...
	    @param			Aucun.
	    @return	cabine	'true' si la cabine de l'engin a été visitée le jour de la vue.
	    				'false' sinon.
	*/
	...
	/**
		RETOURNE LE BOOLEEN 'CABINE' SOUS FORME DE 'STRING' POUR LES FICHIERS XML.
	    @param		Aucun.
	    @return		"1" si la cabine de l'engin a été visitée le jour de la vue.
	    			"0" sinon.
	*/
	...
	/**
	    ...
	    @param newCabine	Nouvelle indication de photo de type 'boolean'.
	    @return				Aucun.
	*/
	...
	*/
	...
	/**
	    ...
	    @param		Aucun.
	    @return		"1" si l'engin a été photographié le jour de la vue.
	    			"0" sinon.
	*/
	...
	/**
	    ...
	    @param newCabine	Nouvelle indication de vidéo de type 'boolean'.
	    @return				Aucun.
	*/
	...
	/**
	    ...
	    @param			Aucun.
	    @return	cabine	'true' si l'engin a été filmé le jour de la vue.
	    				'false' sinon.
	*/
	...
	/**
	    ...
	    @param		Aucun.
	    @return		"1" si l'engin a été filmé le jour de la vue.
	    			"0" sinon.
	*/
	...
	/**
	    ...
	    @param v			Vue à comparer avec 'this', de type 'Vue'.
	...
	*/
	...
	/**
	    ...
	    @param v			Vue dont la date est à comparer avec celle de 'this', de type 'Vue'.
	    @return	resultat	-1 si 'this' est avant 'v'.
							0 si 'this' est à la même date que 'v'.
							1 si 'this' est après 'v'.
	*/

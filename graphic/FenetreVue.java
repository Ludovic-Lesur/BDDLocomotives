...
public class FenetreVue extends JFrame implements ActionListener {
	...
	/**
	    ...
	    @param pModif	Booléen indiquant si la fenêtre doit s'ouvrir en mode ajout ou en mode modification.
	    					'true' = modification d'une vue existante.
	    					'false' = ajout d'une nouvelle vue.
	    @param pVue		Objet 'Vue' à modifier si modif = 'true'.
	    					'null' si modif = 'false'.
	    @param pEngin	Engin moteur dont on doit modifier la vue, de type 'Engin'.
	    @return			Aucun.
	*/
	...
	/**
	    ...
	    @param v		Objet 'Vue' à modifier si modif = 'true'.
		    				'null' si modif = 'false'.
	...
	*/
	...
	/**
		SELECTIONNE LES ITEMS CORRECTS EN FONCTION DES INDICATIONS DIVERSES ACTUELLES DE LA VUE.
	    @param v		Objet 'Vue' à modifier si modif = 'true'.
		    				'null' si modif = 'false'.
	    @param mode		Booléen indiquant si la fenêtre doit s'ouvrir en mode ajout ou en mode modification.
		    				'true' = modification d'une vue existante.
	...
	*/
	public void actionPerformed(ActionEvent e) {
		...
		if (e.getSource() == ok) {
			...
			if (modif == false) {
				engin.getSerie().addXML(Integer.toString(engin.getNumero()), newVue) ;
			}
			else {
				engin.getSerie().modifyXML(Integer.toString(engin.getNumero()), oldVue, newVue) ;
			}

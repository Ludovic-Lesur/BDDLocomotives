...
public class Tableau extends JPanel {
	...
	private Vector<Engin> listeEngins ; // Affichage d'une série et des anniversaires.
	private Vector<Vue> listeVues ; // Affichage d'un engin - vues.
	private Vector<Remarque> listeRemarques ; // Affichage d'un engin - remarques.
	...
	*/
	...
	/**
	    ...
	    @param 		Aucun.
	    @return		'true' si une ligne du tableau a été sélectionnée.
	    			'false' sinon.
	*/
	...
	/**
	    ...
	    @param e		Engin moteur dont on doit afficher les caractéristiques, de type 'Engin'.
	    @param remarque	Booléen indiquant les caractéristiques à afficher.
	...
	*/
	...
	/**
	    ...
	    @param s	Série d'engins moteurs à afficher, de type 'Serie'.
	    @return		Aucun.
	*/
	...
	/**
	    ...
	    @param p	Parc d'engins moteurs à afficher, de type 'Parc'.
	    @return		Aucun.
	*/
	...
	public void update(Serie s) {	
		...
		if (s != null) {
			...
			while (j.hasNext()) {
				...
				String numero = Integer.toString(enginCourant.getNumero()) ;
	...
	*/
	...
	/**
	    ...
	    @param listeAnniv	Liste d'engins moteurs dont c'est l'anniversaire de mise en service, de type Vector<Engin>.
	    @return		Aucun.
	*/
	...
	*/
	public class SerieRenderer extends DefaultTableCellRenderer {
	    ...
	    public Component getTableCellRendererComponent(JTable table, Object value, boolean isSelected, boolean hasFocus, int row, int column) {
	        ...
	        if (serie != null) {
	        	int numero = Serie.stringToInteger(table.getValueAt(row, 0).toString()) ;
	...
	*/
	public class ParcRenderer extends DefaultTableCellRenderer {
	    ...
	    public Component getTableCellRendererComponent(JTable table, Object value, boolean isSelected, boolean hasFocus, int row, int column) {
	        ...
	        setForeground(Color.black) ;
	        // Ligne sur fond jaune si la série n'est pas encore entièrement enregistrée dans la base.
	...
	*/
	public class VueRenderer extends DefaultTableCellRenderer {
	    ...
	    public Component getTableCellRendererComponent(JTable table, Object value, boolean isSelected, boolean hasFocus, int row, int column) {
	        super.getTableCellRendererComponent(table, value, isSelected, hasFocus, row, column) ;
	        // Ligne sur fond jaune si une photo ou une vidéo est associée à la vue

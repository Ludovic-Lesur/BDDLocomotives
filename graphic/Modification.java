...
public class Modification extends JFrame implements ActionListener {
	...
	*/
	...
	/**
	    ...
	    @param newVue	Vue sélectionnée dans le tableau de type 'Vue'.
	    @return			Aucun.
	*/
	...
	/**
	    ...
	    @param newRemarque	Remarque sélectionnée dans le tableau de type 'Remarque'.
	    @return				Aucun.
	*/
	...
	/**
	    ...
	    @param newEngin	Engin sélectionné dans le tableau de type 'Engin'.
	    @return			Aucun.
	*/
	...
	/**
	    ...
	    @param newSerie	Série d'engins moteurs sélectionnée dans le tableau de type 'Serie'.
	    @return			Aucun.
	*/
	...
	/**
	    ...
	    @param e			Engin moteur actuellement affiché de type 'Engin'.
	    @param pRemarque	Booléen indiquant le type de vue.
	    						'true' = affichage des remarques de l'engin.
	    						'false' = affichage des vues de l'engin.
	    @return				Aucun.
	*/
	...
	/**
	    ...
	    @param s	Série d'engins moteurs actuellement affichée de type 'Serie'.
	    @return		Aucun.
	*/
	...
	/**
	    ...
	    @param p	Parc d'engins moteurs actuellement affiché de type 'Parc'.
	    @return		Aucun.
	*/
	...
	/**
	    ...
	    @param listeAnniversaires	Liste d'engins moteurs dont c'est l'anniversaire de mise en service, de type Vector<Engin>.
	    @return						Aucun.
	*/

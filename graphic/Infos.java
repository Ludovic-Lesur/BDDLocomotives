...
public class Infos {
	...
	*/
	public Infos(JPanel mainPanel, GridBagConstraints mainGbc) {
		...
		champ11.setFont(new Font(Interface.police.getFontName(), 2, 25)) ;
		...
		champ12.setFont(new Font(Interface.police.getFontName(), 2, 25)) ;
	...
	/**
	    ...
	    @param mainPanel	Panel de l'interface graphique mère, de type 'JPanel'.
	    @param mainGbc		Contraintes de l'interface graphique mère, de type 'GridBagConstraints'.
	    @param chemin		Chemin absolu de la photo a afficher de type 'String'.
	    @return				Aucun.
	*/
	...
	/**
	    ...
	    @param mainPanel	Panel de l'interface graphique mère, de type 'JPanel'.
	    @param mainGbc		Contraintes de l'interface graphique mère, de type 'GridBagConstraints'.
	    @param e			Engin dont on doit afficher les informations, de type 'Engin'.
	    @return				Aucun.
	*/
	...
	/**
	    ...
	    @param mainPanel	Panel de l'interface graphique mère, de type 'JPanel'.
	    @param mainGbc		Contraintes de l'interface graphique mère, de type 'GridBagConstraints'.
	    @param s			Série dont on doit afficher les informations, de type 'Serie'.
	    @return				Aucun.
	*/
	...
	/**
	    ...
	    @param mainPanel	Panel de l'interface graphique mère, de type 'JPanel'.
	    @param mainGbc		Contraintes de l'interface graphique mère, de type 'GridBagConstraints'.
	    @param p			Parc dont on doit afficher les informations, de type 'Parc'.
	    @return				Aucun.
	*/

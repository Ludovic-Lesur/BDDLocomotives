...
public class FenetreRemarque extends JFrame implements ActionListener {
	...
	public FenetreRemarque(Interface pI, boolean pModif, Remarque pRemarque, Engin pEngin) {
		...
		JScrollPane scroll = new JScrollPane(champObservation, JScrollPane.VERTICAL_SCROLLBAR_AS_NEEDED,
	...
	public void actionPerformed(ActionEvent e) {
		if (e.getSource() == ok) {
			...
			if (modif == false) {
				engin.getSerie().addXML(engin.getNumero(), newRemarque);
			} else {
				engin.getSerie().modifyXML(engin.getNumero(), oldRemarque, newRemarque);
			}

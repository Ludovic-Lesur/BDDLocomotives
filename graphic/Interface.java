...
public class Interface extends JFrame {
	...
	/**
	    ...
	    @param pParcEngins	Parc d'engins moteurs sur lequel soit être démarée l'interface graphique, de type 'Parc'.
	    @return				Aucun.
	*/
	...
	/**
	    ...
	    @param enginTrouve	Engin moteur dont on doit afficher les informations, de type 'Engin'.
	    @param remarque		Booléen indiquant le mode d'affichage.
	...
	*/
	...
	/**
	    ...
	    @param serieTrouvee		Série d'engins moteurs dont on doit afficher les informations, de type 'Serie'.
	    @return	Aucun.
	*/
	...
	*/
	...
	/**
	    ...
	    @param newVue	Objet 'Vue' sélectionnée dans le tableau principal.
	    @return			Aucun.
	*/
	...
	/**
	    ...
	    @param newRemarque	Objet 'Remarque' sélectionnée dans le tableau principal.
	    @return				Aucun.
	*/
	...
	/**
	    ...
	    @param newEngin		Objet 'Engin' sélectionné dans le tableau principal.
	    @return				Aucun.
	*/
	...
	/**
	    ...
	    @param newRemarque	Objet 'Serie' sélectionnée dans le tableau principal.
	    @return				Aucun.
	*/
	...
	*/
	...
	/**
	    ...
	    @param 		Aucun.
	    @return		'true' si une ligne du tableau a été sélectionnée par un clic souris.
	    			'false' sinon.
	*/
	...
	/**
	    ...
	    @param 		Aucun.
	    @return		Date de vue la plus récente de la base de données de type 'String'.
	*/
	...
	/**
	    ...
	    @param date			Date à convertir de type 'LocalDate'.
	    @param formatLong	Booléen indiquant le format de convertion.
	    						'true' : format long avec jour de la semaine et écriture complète.
	    						'false' : format court xx/xx/xxxx.

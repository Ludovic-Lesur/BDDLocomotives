...
public enum Mois {
	...
	/**
	    ...
	    @param pFrenchName		Nom français du mois de type 'String'.
	...
	*/
	...
	/**
	    ...
	    @param 				Aucun.
	    @return	symbol		Symbole du mois utilisé dans les fichiers XML, de type 'String'.
	*/
	...
	*/
	...
	/**
	    ...
	    @return	affectation		Mois associé à 'pEnglishName' si la recherche a donné un résultat.
	    						'Vide' sinon.
	*/

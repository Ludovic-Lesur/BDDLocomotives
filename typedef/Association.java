...
public enum Association {
	...
	/**
	    ...
	    @param pArticle		Article associé au nom de l'association ('l', 'le' ou 'la'), de type 'String'.
	    @param pName		Nom de l'association de type 'String'.
	    @param pGare		Lieu de préservation de l'association de type 'Gare'.
	    @return				Aucun.
	*/
	...
	/**
	    ...
	    @param 				Aucun.
	    @return	symbol		Symbole de l'association utilisé dans les fichiers XML, de type 'String'.
	*/
	...
	/**
	    ...
	    @param 				Aucun.
	    @return	article		Article associé au nom de l'association ('l', 'le' ou 'la'), de type 'String'.
	*/
	...
	*/
	...
	/**
	    ...
	    @return	affectation		Association associée au symbole si la recherche a donné un résultat.
	    						'Vide' sinon.
	*/

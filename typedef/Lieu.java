...
public enum Lieu {
	...
	/**
	    ...
	    @param pName		Nom de lu lieu de type 'String'.
	    @return				Aucun.
	*/
	...
	/**
	    ...
	    @param 				Aucun.
	    @return	symbol		Symbole du lieu utilisé dans les fichiers XML, de type 'String'.
	*/
	...
	*/
	...
	/**
	    ...
	    @return	affectation		Lieu associé au symbole si la recherche a donné un résultat.
	    						'Vide' sinon.
	*/
	...
	*/
	...
	/**
	    ...
	    @param l	Objet 'Lieu' à comparer avec 'this'.
	    @return		'true' si 'this' est égal à 'l'.
	    			'false' sinon.
	*/

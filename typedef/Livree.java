...
public enum Livree {
	...
	/**
	    ...
	    @param pName		Nom de la livrée de type 'String'.
	    @return				Aucun.
	*/
	...
	/**
	    ...
	    @param 				Aucun.
	    @return	symbol		Symbole de la livrée utilisé dans les fichiers XML, de type 'String'.
	*/
	...
	*/
	...
	/**
	    ...
	    @return	affectation		Livrée associée au symbole si la recherche a donné un résultat.
	    						'Vide' sinon.
	*/

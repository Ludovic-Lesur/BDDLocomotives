...
public enum Depot {
	...
	/**
	    ...
	    @param pName		Nom du dépôt de type 'String'.
	    @param pCouleur		Code couleur du dépôt pour l'affichage de type 'Color'.
	    @return				Aucun.
	*/
	...
	*/
	...
	/**
	    ...
	    @return	affectation		Dépôt associé au symbole si la recherche a donné un résultat.
	    						'Vide' sinon.
	*/
